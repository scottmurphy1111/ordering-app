<script lang="ts" module>
	...
	export const buttonVariants = tv({
		...
		variants: {
			...
			size: {
				default:
					'h-8 px-3 gap-1.5 has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2',
...
<!-- href is passed in from call sites that wrap it in resolve(); the rule cannot trace through prop indirection -->
