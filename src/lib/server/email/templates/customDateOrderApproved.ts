...
export function customDateOrderApprovedEmail({
	...
	const content = `
    <h1 style="margin:0 0 4px;font-size:24px;font-weight:700;color:#111827;">Order approved!</h1>
    <p style="margin:0 0 24px;font-size:15px;color:#6b7280;">Hey ${customerName}, your custom date order has been approved and your card has been charged.</p>
