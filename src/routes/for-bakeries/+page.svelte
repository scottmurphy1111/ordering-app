...
<!-- Hero -->
<section class="relative overflow-hidden bg-gradient-to-b from-amber-50/60 to-background px-6 pt-24 pb-16">
	<div class="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(ellipse_80%_50%_at_50%_-10%,rgba(251,191,36,0.10),transparent)]"></div>
...
<section class="bg-amber-50 px-6 py-16">
	<div class="mx-auto max-w-2xl text-center">
		...
		<p class="mt-3 text-base leading-relaxed text-gray-700">
			We're signing up our first 25 bakery partners at a founding rate. You get the full Pro plan — unlimited items, multiple pickup locations, website embed, priority support — locked at $49/mo as long as you stay active.
		</p>
...
<section id="pricing" class="scroll-mt-20 bg-background px-6 py-24">
	<div class="mx-auto max-w-4xl">
		<div class="mb-10 text-center">
			...
			<p class="mt-3 text-lg text-muted-foreground">Keep 100% of your sales. Pay only Stripe's standard processing fee.</p>
		</div>
		...
		<div class="grid gap-6 sm:grid-cols-2">
			...
			<div class="flex flex-col overflow-hidden rounded-2xl border bg-background">
				<div class="flex flex-1 flex-col p-7">
					...
					<p class="mt-1 text-sm text-muted-foreground">For growing bakeries taking regular pre-orders.</p>
			...
			<div class="relative flex flex-col overflow-hidden rounded-2xl border border-primary shadow-2xl ring-2 ring-primary/20">
				<div class="absolute -top-3 left-0 right-0 flex justify-center">
					<span class="rounded-full bg-primary px-3 py-1 text-xs font-semibold text-white shadow-sm">Most popular for bakeries</span>
				</div>
				<div class="h-1 bg-primary"></div>
				<div class="flex flex-1 flex-col p-7">
					<p class="text-lg font-bold text-foreground">Pro</p>
					<p class="mt-1 text-sm text-muted-foreground">The full toolkit for established bakeries and holiday volume.</p>
					<div class="mt-5 flex items-end gap-x-2">
		...
		<p class="mt-6 text-center text-sm text-muted-foreground">
			Not sure? Start free on our <a href={loginHref} class="text-primary underline underline-offset-2 hover:text-primary/80">Starter plan</a> — up to 10 items, no credit card required.
		</p>
	</div>
</section>
