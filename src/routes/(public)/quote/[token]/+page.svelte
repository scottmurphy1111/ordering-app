<script lang="ts">
	...
	const form = $derived(
		_form as
			| { acceptError?: string; acceptSuccess?: boolean; declineError?: string; declineSuccess?: boolean }
			| null
	);
			...
			<div class="rounded-lg border bg-background p-6 sm:p-8">
				<div class="mb-6">
					...
					<p class="mt-1.5 text-sm text-muted-foreground">
						{vendor.name} has put together a quote for your custom order request.
					</p>
				</div>
				...
				<!-- Price block -->
				<div
					class="mb-5 rounded-lg border border-gray-100 bg-gray-50 px-5 py-4 text-center"
				>
