							...
							<div class="flex items-start justify-between gap-3">
								<div class="min-w-0 flex-1">
									<div class="flex flex-wrap items-center gap-2">
										<span class="text-sm font-medium text-foreground">{req.customerName}</span>
										<span class="text-xs text-muted-foreground">{req.customerEmail}</span>
									...
									<p class="mt-1 line-clamp-2 text-xs text-muted-foreground">{req.description}</p>
								</div>
								<div class="flex shrink-0 flex-col items-end gap-1">
									<span class="text-xs text-muted-foreground">{formatDate(req.createdAt)}</span>
									{#if req.targetDate}
							...
							<div class="border-t px-4 py-4">
								<div class="space-y-3">
									...
									<div>
										...
										<p class="text-sm whitespace-pre-wrap text-foreground">{req.description}</p>
									</div>
											...
											<div class="flex flex-wrap gap-2">
												{#each req.photoUrls as string[] as url, i (i)}
													...
													<a
														...
														class="block h-20 w-20 overflow-hidden rounded-lg border"
													>
														<img
															src={url}
