...
<Card class="bg-background/95 md:bg-background">
	<CardContent class="p-8">
		...
		<!-- Magic link form -->
		{#if magicSent}
			<div class="rounded-lg border border-primary/20 bg-primary/5 px-4 py-4 text-center">
				<p class="text-sm font-medium text-primary">Check your email</p>
				<p class="mt-1 text-sm text-primary/90">
